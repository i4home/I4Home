                ...
                <div class="text-center text-muted mx-auto mt-4 w-75 mb-4">
                    ...
                    <table class="table">
                        <tr class="mh-25">
                            ...
                            <td><input type="checkbox" class="" id="bed2_fan" onchange="bed2_fan()" data-toggle="toggle" data-onstyle="success"
                                    data-offstyle="danger"></td>
                        </tr>
                        <tr class="mh-25">
                            <td><img src="devices/bulb.png" alt="bulb" class="img-fluid w-50" /></td>
                            <td><input type="checkbox" class="" id="bed2_bulb" onchange="bed2_bulb()" data-toggle="toggle" data-onstyle="success"
                                    data-offstyle="danger"></td>
                        </tr>
                        <tr class="mh-25">
                            <td><img src="devices/tv.png" alt="tv" class="img-fluid w-50" /></td>
                            <td><input type="checkbox" class="" id="bed2_tv" onchange="bed2_tv()" data-toggle="toggle" data-onstyle="success"
                                    data-offstyle="danger"></td>
                        </tr>
                        <tr class="mh-25">
                            <td><img src="devices/ac.png" alt="ac" class="img-fluid w-50" /></td>
                            <td><input type="checkbox" class="" id="bed2_ac" onchange="bed2_ac()" data-toggle="toggle" data-onstyle="success"
                                    data-offstyle="danger"></td>
                        </tr>
                        <tr class="mh-25">
                            <td><img src="devices/plug.png" alt="plug" class="img-fluid w-50" /></td>
                            <td><input type="checkbox" class="" id="bed_plug" onchange="bed_plug()" data-toggle="toggle" data-onstyle="success"
                                    data-offstyle="danger"></td>
                        </tr>
                </div>
            </div>
