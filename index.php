                    ...
                    <form class="form-signin" role="form" action="validate.php" method="post">
                        ...
                        <div class="form-group input-group">
                            <span class="input-group-addon">
                                <img src="index\user-solid.svg" class="img" width="15px">
                            </span>
                        ...
                        <br>
                        <div class="form-group input-group">
                            <span class="input-group-addon"> <img src="index\unlock-alt-solid.svg" class="img"
                                    width="15px"></span>
                        ...
                        <button type="submit" name="login" value="Login" class="btn btn-primary btn-block"><img
                                src="index\sign-in-alt-solid.svg" class="img" width="15px">&nbsp; Login</button>
