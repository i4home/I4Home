                ...
                <div class="text-center text-muted mx-auto mt-4 w-75 mb-4">
                    ...
                    <table class="table">
                        <tr class="mh-25">
                            ...
                            <td><input type="checkbox" class="" id="kitchen_fan" onchange="kitchen_fan()" data-toggle="toggle" data-onstyle="success"
                                    data-offstyle="danger"></td>
                        </tr>
                        <tr class="mh-25">
                            <td><img src="devices/bulb.png" alt="bulb" class="img-fluid w-50" /></td>
                            <td><input type="checkbox" class="" id="kitchen_bulb" onchange="kitchen_bulb()" data-toggle="toggle" data-onstyle="success"
                                    data-offstyle="danger"></td>
                        </tr>
                        <tr class="mh-25">
                            <td><img src="devices/fridge.png" alt="fridge" class="img-fluid w-50" /></td>
                            <td><input type="checkbox" class="" id="kitchen_fridge" onchange="kitchen_fridge()" data-toggle="toggle" data-onstyle="success"
                                    data-offstyle="danger"></td>
                        </tr>
                        <tr class="mh-25">
                            <td><img src="devices/microwave oven.png" alt="microwave oven" class="img-fluid w-50" />
                            </td>
                            <td><input type="checkbox" class="" id="kitchen_microwave" onchange="kitchen_microwave()" data-toggle="toggle" data-onstyle="success"
                                    data-offstyle="danger"></td>
                        </tr>
                        <tr class="mh-25">
                            <td><img src="devices/plug.png" alt="plug" class="img-fluid w-50" /></td>
                            <td><input type="checkbox" class="" id="kitchen_plug" onchange="kitchen_plug()" data-toggle="toggle" data-onstyle="success"
                                    data-offstyle="danger"></td>
                        </tr>
                </div>
            </div>
