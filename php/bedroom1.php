                    ...
                    <table class="table">
                        <tr class="mh-25">
                            ...
                            <?php
                                ...
                                else if(isset($_GET['bd1_fan_off']))
                                {
                        ...
                        <tr class="mh-25">
                            ...
                            <?php
                                ...
                                else if(isset($_GET['bd1_bulb_off']))
                                {
                                        $gpio_off = shell_exec("gpio -g write 12 1");
                                        echo'<script>  
                        ...
                        <tr class="mh-25">
                            ...
                            <?php
                                ...
                                else if(isset($_GET['bd1_plug_off']))
                                {
                                        $gpio_off = shell_exec("gpio -g write 12 1");
                                        echo'<script>  
