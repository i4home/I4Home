                ...
                <div class="text-center text-muted mx-auto mt-4 w-75 mb-4">
                    ...
                    <table class="table">
                        <tr class="mh-25">
                            ...
                            <td>
                                <form method="POST" action="bedroom2.php">
                            ...
                            <?php
                                ...
                                else if(isset($_POST['bd2_fan_off']))
                                {
                        ...
                        <tr class="mh-25">
                            ...
                            <?php
                                ...
                                else if(isset($_POST['bd2_bulb_off']))
                                {
                                        $gpio_off = shell_exec("gpio -g write 12 1");
                                        echo'<script>  
                        ...
                        <tr class="mh-25">
                            ...
                            <?php
                                ...
                                else if(isset($_POST['bd2_tv_off']))
                                {
                                        $gpio_off = shell_exec("gpio -g write 12 1");
                                        echo'<script>  
                        ...
                        <tr class="mh-25">
                            ...
                            <?php
                                ...
                                else if(isset($_POST['bd2_ac_off']))
                                {
                                        $gpio_off = shell_exec("gpio -g write 12 1");
                                        echo'<script>  
                        ...
                        <tr class="mh-25">
                            ...
                            <?php
                                ...
                                else if(isset($_POST['bd2_plug_off']))
                                {
                                        $gpio_off = shell_exec("gpio -g write 12 1");
                                        echo'<script>  
